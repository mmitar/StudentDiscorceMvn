...
<!-- Renders the content in the left menu if a course model was recognized -->
<c:choose>
	<c:when test="${not empty courses}">
	
		<div class="channels">
		
			<!-- Navigable Add New Course Button / Old Nav to CourseList -->
			<!-- <a style="padding: 0; background: #486593" href="../course/new" class="channel centerFrame"> For courseList -->
			<div>
			<a style="padding: 0; background: #486593" href="../course/addCourse" class="channel centerFrame">
	    	...
	    	<!-- Course List that populates with recognized course model list. -->
	    	...
	    	<ul id="sortable">
	    		<c:forEach items="${courses}" var="course" varStatus="status">
	    			...
	    			<c:if test="${not empty course}">
		    			<li class="channel" style=" background-image: url(${course.image})" >
